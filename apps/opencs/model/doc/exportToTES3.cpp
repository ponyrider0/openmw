...
CSMDoc::OpenExportStage::OpenExportStage (Document& document, SavingState& state, bool projectFile)
	: mDocument (document), mState (state), mProjectFile (projectFile)
{}

int CSMDoc::OpenExportStage::setup()
{
	return 1;
}

void CSMDoc::OpenExportStage::perform (int stage, Messages& messages)
{
...
CSMDoc::ExportHeaderStage::ExportHeaderStage (Document& document, SavingState& state, bool simple)
	: mDocument (document), mState (state), mSimple (simple)
{}

int CSMDoc::ExportHeaderStage::setup()
{
	return 1;
}

void CSMDoc::ExportHeaderStage::perform (int stage, Messages& messages)
{
...
CSMDoc::ExportDialogueCollectionStage::ExportDialogueCollectionStage (Document& document,
...
int CSMDoc::ExportDialogueCollectionStage::setup()
{
	return mTopics.getSize();
}

void CSMDoc::ExportDialogueCollectionStage::perform (int stage, Messages& messages)
{
...
CSMDoc::ExportRefIdCollectionStage::ExportRefIdCollectionStage (Document& document, SavingState& state)
	: mDocument (document), mState (state)
{}

int CSMDoc::ExportRefIdCollectionStage::setup()
{
	return mDocument.getData().getReferenceables().getSize();
}

void CSMDoc::ExportRefIdCollectionStage::perform (int stage, Messages& messages)
{
	mDocument.getData().getReferenceables().save (stage, mState.getWriter());
}


CSMDoc::ExportReferenceCollectionStage::ExportReferenceCollectionStage (Document& document,
	SavingState& state)
	: mDocument (document), mState (state)
{}

int CSMDoc::ExportReferenceCollectionStage::setup()
{
...
void CSMDoc::ExportReferenceCollectionStage::perform (int stage, Messages& messages)
{
	int size = mDocument.getData().getReferences().getSize();
...
CSMDoc::ExportCellCollectionStage::ExportCellCollectionStage (Document& document,
	SavingState& state)
	: mDocument (document), mState (state)
{}

int CSMDoc::ExportCellCollectionStage::setup()
{
	return mDocument.getData().getCells().getSize();
}

void CSMDoc::ExportCellCollectionStage::perform (int stage, Messages& messages)
{
	ESM::ESMWriter& writer = mState.getWriter();
...
CSMDoc::ExportPathgridCollectionStage::ExportPathgridCollectionStage (Document& document,
	SavingState& state)
	: mDocument (document), mState (state)
{}

int CSMDoc::ExportPathgridCollectionStage::setup()
{
	return mDocument.getData().getPathgrids().getSize();
}

void CSMDoc::ExportPathgridCollectionStage::perform (int stage, Messages& messages)
{
	ESM::ESMWriter& writer = mState.getWriter();
...
CSMDoc::ExportLandCollectionStage::ExportLandCollectionStage (Document& document,
	SavingState& state)
	: mDocument (document), mState (state)
{}

int CSMDoc::ExportLandCollectionStage::setup()
{
	return mDocument.getData().getLand().getSize();
}

void CSMDoc::ExportLandCollectionStage::perform (int stage, Messages& messages)
{
	ESM::ESMWriter& writer = mState.getWriter();
...
CSMDoc::ExportLandTextureCollectionStage::ExportLandTextureCollectionStage (Document& document,
	SavingState& state)
	: mDocument (document), mState (state)
{}

int CSMDoc::ExportLandTextureCollectionStage::setup()
{
	return mDocument.getData().getLandTextures().getSize();
}

void CSMDoc::ExportLandTextureCollectionStage::perform (int stage, Messages& messages)
{
	ESM::ESMWriter& writer = mState.getWriter();
...
CSMDoc::CloseExportStage::CloseExportStage (SavingState& state)
	: mState (state)
{}

int CSMDoc::CloseExportStage::setup()
{
	return 1;
}

void CSMDoc::CloseExportStage::perform (int stage, Messages& messages)
{
...
CSMDoc::FinalizeExportStage::FinalizeExportStage (Document& document, SavingState& state)
	: mDocument (document), mState (state)
{}

int CSMDoc::FinalizeExportStage::setup()
{
	return 1;
}

void CSMDoc::FinalizeExportStage::perform (int stage, Messages& messages)
{
	if (mState.hasError())
	{
