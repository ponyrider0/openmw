#ifndef OPENMW_TES4SCRIPT_COMPILER_H
#define OPENMW_TES4SCRIPT_COMPILER_H
...
namespace ESM {
	...
	public:
		...
		TES4ScriptCompiler(const std::string& scriptText, ESM::ESMWriter& esm, CSMDoc::Document &doc);
		void processScript();
