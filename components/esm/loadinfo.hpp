...
struct DialInfo
{
	...
	void exportTESx(ESMWriter &esm, int export_format, int newType, const std::string& topicEDID, std::vector<std::string>& addTopicList, uint32_t prevRecordID=0) const;
